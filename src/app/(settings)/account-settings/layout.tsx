      ...
      <div className="min-h-screen bg-[#fcfcfc]">
        ...
        <Container>
          <div className="pt-20 flex flex-col md:flex-row min-h-screen ">
            <div className=" w-full md:w-[17vw] border-b md:border-b-0 md:border-r pt-4 md:pt-10 pr-0 md:pr-4 pb-3 md:pb-0">
              <div
...
const NavData = [
  {
    name: "Overview",
    icon: <FiUser className="font-medium" />,
    route: "/account-settings",
  },
  {
    name: "Password",
    icon: <RiKey2Line className="font-medium" />,
    route: "/account-settings/password",
  },
  {
    name: "Notifications",
    icon: <GoBell className="font-medium" />,
    route: "/account-settings/notifications",
  },
  {
    name: "Lagal & Terms",
    icon: <TfiCheckBox className="font-medium" />,
    route: "/account-settings/legal-and-terms",
  },
];
