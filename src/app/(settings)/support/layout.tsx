      ...
      <div className="min-h-screen bg-[#fcfcfc]">
        ...
        <Container>
          <div className="pt-20 flex flex-col md:flex-row min-h-screen ">
            <div className=" w-full md:w-[17vw] border-b md:border-b-0 md:border-r pt-4 md:pt-10 pr-0 md:pr-4 pb-3 md:pb-0 border-gray-200">
              <div
...
const NavData = [
  // {
  //   name: "Browse Help Topics",
  //   icon: <FiGlobe className="font-medium" />,
  //   route: "/support",
  // },
  {
    name: "FAQs",
    icon: <IoMdHelpCircleOutline className="font-medium " />,
    route: "/support/faqs",
  },
  {
    name: "Contact Us",
    icon: <PiPhoneCallLight className="font-medium" />,
